    ...
    questions: [
      {
        ...
        answers: [
          {
            message: 'É seguir o papel do personagem dentro do jogo',
            correct: true,
          },
          {
            message: 'Matar alguém sem uma ação válida e dentro das regras',
            correct: false,
          },
      ...
      },
      {
        ...
        answers: [
          ...
          {
            message: 'Matar um jogador propositalmente com um veículo',
            correct: true,
          },
          { message: 'Utilizar um veículo como arma', correct: true },
          {
            message: 'Destruir o veículo de um jogador sem motivo',
            correct: false,
          },
        ],
      },
      {
        ...
        answers: [
          ...
          {
            message: 'Atirar em um jogador sem uma ação prévia',
            correct: true,
          },
      ...
      },
      {
        ...
        answers: [
          {
            message:
              'Comunicar-se com meu amigo por meio de uma ferramenta externa',
            correct: true,
          },
          {
            message:
              'Obter informações privilegiadas de um streamer por meio da sua stream',
            correct: true,
          },
      ...
      },
      {
        ...
        answers: [
          ...
          {
            message:
              'Abusar da física do jogo, fazendo algo que não seria possível na vida real',
            correct: true,
          },
      ...
      },
      {
        ...
        answers: [
          {
            message:
              'Ficar inconsciente em uma ação e aguardar os médicos chegarem',
            correct: false,
          },
          {
            message:
              'Ser morto durante uma ação, portanto não posso ser revivido e não lembrarei dos últimos 15 minutos',
            correct: true,
          },
        ],
      },
      {
        ...
        answers: [
          {
            message:
              'Uma área onde você pode matar outros jogadores sem iniciar uma ação',
            correct: false,
          },
          {
            message:
              'Uma área, local ou NPC onde você não pode praticar qualquer tipo de crime',
            correct: true,
          },
        ],
      },
      {
        ...
        answers: [
          {
            message: 'Definitivamente não são permitidos músicas no jogo',
            correct: false,
          },
          {
            message:
              'Quando você tem um carro, um celular, uma caixa de som ou algo que possa reproduzir música',
            correct: true,
          },
        ],
      },
      {
        ...
        answers: [
          {
            message: 'Não, todos os jogadores devem ser respeitados',
            correct: true,
          },
      ...
      },
      {
        ...
        answers: [
          {
            message:
              'Não é permitido qualquer tipo de linguajar perigoso (racismo, xenofobia, homofobia)',
            correct: true,
          },
          { message: 'Valorize a sua vida como se fosse única', correct: true },
          {
            message:
              'Se alguém aponto uma arma em sua cabeça, você deve seguir o roleplay',
            correct: true,
          },
          {
            message:
              'Em caso de abuso de bugs, chame um administrador e se possível, grave a cena',
            correct: true,
          },
          {
            message:
              'Evite trazer coisas da vida real para o jogo. (exemplo: "aperta F5")',
            correct: true,
          },
          {
            message:
              'Se você viu uma ação de anti-rp, grave e mostre a um administrador',
            correct: true,
          },
