...
const config: ConfigSchema = {
  bot: {
    token: "NzA5MjE3NTY0NjMwNDUwMjc2.XroL4Q.3iCSQUlPnPi9-HEVINW8xYfgGPQ"
  },
  server: {
    channel: "706978411691638806",
    category: '706978064180969573',
    greeting: `:shark: **Whitelist**
    Seja bem-vindo ao **MARGINAIS RP**!
  ...
  whitelist: [
    ...
    },
    {
      ...
      answers: [
        ...
        { message: 'Sair do papel do personagem durante uma abordagem', correct: true },
        { message: 'Ir até a DP e atirar nos policiais', correct: true },
        { message: 'Roubar um carro estacionado na praia', correct: false },
      ]
    },
    {
    ...
    },
    {
      ...
      answers: [
        { message: 'Comunicar-se com meu amigo fora do jogo', correct: true },
        { message: 'Obter informações privilegiadas de um streamer por meio da sua stream', correct: false },
	...
	{
      question: 'Selecione um exemplo de Ghosting:',
      answers: [
        { message: 'Se esconder da policia enquanto está sendo procurado', correct: false },
        { message: 'Obter informações privilegiadas de um streamer por meio da sua stream', correct: true },
        { message: 'Comunicar-se com meu amigo fora do jogo', correct: false },
        { message: 'Desconectar durante uma ação', correct: false },
      ]
    },
    {
    ...
    },
    {
      ...
      answers: [
        ...
        { message: 'Uma área ou local onde você não pode praticar qualquer tipo de crime', correct: true },
      ]
    },
    {
    ...
    },
    {
      ...
      answers: [
        ...
        { message: 'Se alguém aponta uma arma em sua cabeça, você deve seguir o roleplay', correct: true },
